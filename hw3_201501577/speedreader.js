(function() {
    ...
    window.onload = function() {
        //sets initial abilities for the controls
    ...
    //Function that is called when the speed option is changed. Stops the current 
    //timer and resets the timer to include the new speed.
    function newTimer() {
        if(!$("stop").disabled) {
            clearInterval(timer);
            createTimer();
